                    ...
                    <Select onValueChange={color => field.onChange(color)}>
                      ...
                      <SelectContent className='w-full'>
                        {Object.keys(CollectionColors).map(color => (
                          ...
                          key={color} 
                          value={color} 
                          className={cn('w-full h-8 rounded-md my-1 text-white focus:text-white focus:font-bold focus:ring-2 ring-neutral-600 focus:ring-inset dark:focus:ring-white focus:px-8', CollectionColors[color as CollectionColor])}>
                            {color}
                          </SelectItem>
                        ))}
                      </SelectContent>
